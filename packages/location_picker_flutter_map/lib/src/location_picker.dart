...
class _FlutterLocationPickerState extends State<FlutterLocationPicker>
  ...
  LatLng circleLatLng = LatLng(30.0443879, 31.2357257);
  ...
  void initState() {
    ...
    if (widget.trackMyPosition) {
      ...
      circleLatLng = initPosition.toLatLng();
        ...
        options: MapOptions(
          onPositionChanged: (position, status){
            setState((){
              ...
              circleLatLng = LatLng(position.center!.latitude, position.center!.longitude);
            });
          },
          ...
          CircleLayer(
            circles: [
              CircleMarker(
                ...
                point: circleLatLng,
                radius: widget.circleRadius * 1000,
